    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-primary-800 dark:text-primary-100 text-center">
            Voice Companion
          </h2>
        ...
        <div className="h-[600px] flex flex-col">
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center">
                <div className="w-24 h-24 rounded-full bg-primary-100 dark:bg-primary-800 flex items-center justify-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-primary-600 dark:text-primary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-6">
              {messages.map((message) => (
                ...
                >
                  <div 
                    className={`flex items-center space-x-3 max-w-[80%] ${
                      message.type === 'user' 
                    ...
                    <div className="w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center">
                      {message.type === 'user' ? (
                        <div className="bg-secondary-200 dark:bg-secondary-700 w-full h-full rounded-full flex items-center justify-center">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-secondary-600 dark:text-secondary-300" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="relative">
            <div className="absolute bottom-0 left-0 right-0 flex justify-center items-center p-6 bg-gradient-to-t from-white to-transparent dark:from-gray-800 dark:to-transparent">
              <button
              ...
              <div className="absolute -bottom-6 left-0 right-0 text-center text-xs text-gray-600 dark:text-gray-400">
